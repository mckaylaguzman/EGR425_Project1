...
void loop()
{
    ...
    if ((millis() - lastTime) > timerDelay)
    {
        if (WiFi.status() == WL_CONNECTED)
        {
            ...
            // Examples: https://api.openweathermap.org/data/2.5/weather?q=riverside,ca,usa&units=imperial&appid=e969174f41509785bfde66d63dee09ae
            //////////////////////////////////////////////////////////////////
            ...
            String strWeatherDesc = objWeather0["main"]; // alternate way: objResponce["weather"][0]["main"];
